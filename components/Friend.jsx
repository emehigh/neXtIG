...
const Friend = ({username, picture, email, postsNumber, id}) => {
  return (
    ...
    // {postsNumber}
    // </div>
    <Link href={`/profile?id=${id}`} class="w-full mt-5 dark:bg-slate-800 gap-6 flex items-center justify-center">
      <div
        class="bg-gray-100 w-1/2 dark:bg-gray-700 relative shadow-xl overflow-hidden hover:shadow-2xl group rounded-xl p-5 transition-all duration-500 transform">
